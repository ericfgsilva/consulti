...
class gsp_consultorio_consultacreate_gsp extends GroovyPage {
public String getGroovyPageFileName() { "/WEB-INF/grails-app/views/consulta/create.gsp" }
public Object run() {
Writer out = getOut()
...
invokeTag('access','sec',73,['expression':("hasRole('ROLE_DOCTOR')")],2)
printHtmlPart(10)
})
